        ...
        if isfield(matData,'A')
            ...
            MBC.A(new_seq_states,new_seq_states,iaz) = ...
                   ...
                   (  matData.A(new_seq_states,new_seq_states,iaz) * ...
                      [T1,                                         zeros(matData.ndof2),    zeros(matData.ndof1); ...
                      matData.Omega(iaz)*T2,                       T1,                      zeros(matData.ndof1); ...
                      zeros(matData.ndof1),                        zeros(matData.ndof1),    T1q] ...
                      ...
                    - [matData.Omega(iaz)*T2,                      zeros(matData.ndof2),    zeros(matData.ndof1); ...
                      OmegaSquared*T3 + matData.OmegaDot(iaz)*T2,  2*matData.Omega(iaz)*T2, zeros(matData.ndof1); ...
                      zeros(matData.ndof1),                        zeros(matData.ndof1),    matData.Omega(iaz)*T2q] ...
                   );
